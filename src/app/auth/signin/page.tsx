...
export default function SignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false)
      // Auto-redirect to home page (bypassing auth)
      router.replace('/')
    }, 1000)
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-secondary-900 dark:to-secondary-800 px-4">
      <div className="w-full max-w-md bg-white dark:bg-secondary-800 rounded-xl shadow p-8">
        ...
        <button
          ...
          className="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium flex items-center justify-center gap-2 mb-3"
        >
        ...
        <button
          ...
          className="w-full py-2 bg-white border border-secondary-200 dark:border-secondary-600 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-secondary-50 dark:hover:bg-secondary-700 text-secondary-900 dark:text-white"
        >
